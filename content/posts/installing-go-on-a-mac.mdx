...
description: "In this article, I am going to show you how to install & setup Go (Golang) on Mac and also setup/configure VS Code for writing Go (Golang) code. In this article, I am going to show you how to install & setup Go (Golang) on Mac and also setup/configure VS Code for writing Go (Golang) code."
date: "2023-01-16"
url: "/"
hero: "/images/Golang-Basics.png"
tags: [{"label": "Terminal", "value": "terminal"}, {"label": "Go", "value": "go"}]
published: true
---
