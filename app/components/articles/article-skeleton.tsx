export default function ArticleSkeleton () {
  return (
    ...
    >
      ...
      <div className='px-4 md:px-8 pb-10 mt-8'>
        ...
        <div className='h-6 bg-gray-200 rounded-lg dark:bg-gray-700 mt-4'></div>
        <div className='h-6 bg-gray-200 rounded-lg dark:bg-gray-700 mb-8 mt-4 w-5/6'></div>
